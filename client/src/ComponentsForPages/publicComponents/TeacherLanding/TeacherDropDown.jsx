...
import TeacherLandingHeader from './TeacherLandingHeader'


const TeacherDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      <TeacherLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} />
