...
const VoulunteerCard = ({ job, highlightText }) => {
  ...
  return (
    <div style={{ background: "rgba(250, 235, 215, 0.960)", width: "98%", margin: "1vh 1vw", padding: "1vh" }}>
      ...
      <div style={{ display: "flex" }}>
        <h6 style={{ width: "100%", textAlign: "center" }}>{highlightText ? highlightText("Volunteer Work") : "Volunteer Work"}</h6>
