...
import JoinLandingHeader from './JoinLandingHeader'
import { Link } from 'react-router-dom'
import moment from 'moment'

const JoinDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      {/* <JoinLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} /> */}
        ...
        >
          ...
          {openMenu === "support" && (
            ...
            >
              ...
              <Link to={"/join"}>
                <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Join The Cause</button>
              </Link>
