...
const NewsDropDown = ({ darkMode, setDarkMode, openMenu, setOpenMenu, allStories, allEvents, allNewsLetters }) => {
    ...
    <div >
      ...
      >
        ...
        <div
          ...
          className="rounded responsiveDiv"
              ...
              {allNewsLetters?.length === 0 ? "Currently No Newsletters To View" :
                <>
                  ...
                  {allNewsLetters?.length > MAX_VISIBLE && (
                    ...
                    <button className="rounded" disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON See All News Letters </button>
