...
import MentorLandingHeader from '../MentorLanding/MentorLandingHeader';

const MentorDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, data }) => {
  ...
  return (
    ...
    <div >
      {landingContent?.mentorImgBucketName && landingContent?.mentorSub !== "" || landingContent?.mentorMainImg && landingContent?.mentorSub !== "" ?
        <MentorLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} data={data} newGif={newGif} newGif2={newGif2} />
        : ""}
      ...
      >
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "who" && (
            ...
            >
              <Link to={"/why"}>
                <button className='rounded' style={{ background: "goldenRod", width: "100%", margin: "0.5vh 0", color: "black" }}>Why We Exists</button>
              </Link>
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "what" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Mentorship Program</button>
        ...
        >
          ...
          {openMenu === "news" && (
            ...
            <div className="dropdownPanel" style={{ background: "white", border: "2px solid black" }} >
              ...
              <Link to={"/subscribe"}>
                <button className="rounded" style={{ background: "goldenRod", width: "100%", margin: "0.5vh 0", color: "black" }} > Subscribe To Our NewsLetter </button>
              </Link>
