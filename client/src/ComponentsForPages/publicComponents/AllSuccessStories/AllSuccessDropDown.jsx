...
const AllSuccessDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
                  ...
                  <>
                    ...
                    {publishedStories?.length > MAX_VISIBLE && !showAll && (
                      ...
                      <Link to={"/allSuccessStory"}>
                        <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON See All Success Stories </button>
                      </Link>
                    )}
...
export default AllSuccessDropDown
