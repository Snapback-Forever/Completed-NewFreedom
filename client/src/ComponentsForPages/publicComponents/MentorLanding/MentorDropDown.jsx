...
import MentorLandingHeader from './MentorLandingHeader'
...
const MentorDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, data }) => {
  ...
  return (
    ...
    <div >
      {landingContent?.mentorImgBucketName && landingContent?.mentorSub ?
        <MentorLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} data={data} />
        : ""}
