...
import VisitProLandingHeader from './VisitProLandingHeader'

const VisitProDropDown = ({ darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, singleProgram }) => {
  ...
  return (
    ...
    <div >
      ...
      <VisitProLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} singleProgram={singleProgram} />
...
export default VisitProDropDown
