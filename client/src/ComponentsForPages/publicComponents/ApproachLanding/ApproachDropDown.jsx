...
import ApproachLandingHeader from './ApproachLandingHeader'
import moment from 'moment'
import { Link } from 'react-router-dom'

const ApproachDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      <ApproachLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} newGif={newGif} newGif2={newGif2} />
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "what" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Our Approach</button>
...
export default ApproachDropDown
