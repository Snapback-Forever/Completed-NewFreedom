...
const ApproachLandingContent = ({ darkMode, setDarkMode, landingContent, allStories, allSupporters, allPrograms }) => {
  ...
  return (
    ...
    <div style={{ minHeight: "38%", color: !darkMode ? "black" : "white" }}>
      ...
      {landingContent?.approachVideo?.startsWith("http") ?
      ...
      <h1 style={{ width: "100%", textAlign: "center" }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(landingContent?.approachTitle) }} />
      <div style={{ width: "100%", padding: "1vh 1vw" }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(landingContent?.approachContent) }} />
...
export default ApproachLandingContent
