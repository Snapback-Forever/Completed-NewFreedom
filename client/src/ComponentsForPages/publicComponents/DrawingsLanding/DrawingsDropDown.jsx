...
import DrawingsLandingHeader from './DrawingsLandingHeader'
import { Link } from "react-router-dom"
import moment from 'moment'

const DrawingsDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, allDrawing }) => {
  ...
  return (
    ...
    <div >
      ...
      <DrawingsLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} allDrawing={allDrawing} />
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "happening" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Drawings Sent To NF</button>
