...
import OutPatientLandingHeader from './OutPatientLandingHeader'
import moment from 'moment'
import { Link } from 'react-router-dom'

const OutPatientDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      <OutPatientLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} newGif={newGif} newGif2={newGif2} />
      ...
      >
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "what" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Outreach Services</button>
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv'>
          <button
            className="responsiveButton rounded" onMouseLeave={() => setOpenMenu("")}
