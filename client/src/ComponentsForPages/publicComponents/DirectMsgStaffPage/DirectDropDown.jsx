...
import DirectLandingHeader from './DirectLandingHeader'

const DirectDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, singleUser }) => {
  ...
  return (
    ...
    <div >
      ...
      <DirectLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} singleUser={singleUser} />
