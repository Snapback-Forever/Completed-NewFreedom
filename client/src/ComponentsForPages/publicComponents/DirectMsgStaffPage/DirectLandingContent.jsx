...
const DirectLandingContent = ({ darkMode, singleUser }) => {
    ...
    return (
        ...
        >
            ...
            <div className='messageUs' style={{ width: "100vw", display: "flex", flexDirection: "column", alignItems: "center", background: !darkMode ? "rgba(255, 255, 255, 0.663)" : "rgba(0, 0, 0, 0.63)", margin: "0 0 2vh 0", color: darkMode ? "white" : "black", }}>
                ...
                <h4 style={{ width: "90%", textAlign: "center" }}>Please Make Sure You Submit Your Correct Email So {singleUser?.firstName} Can Respond. {singleUser?.firstName} Look's Forward To Hearing From You. </h4>
            </div>
