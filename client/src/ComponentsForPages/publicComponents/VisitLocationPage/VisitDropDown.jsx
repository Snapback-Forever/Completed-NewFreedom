...
import VisitLandingHeader from './VisitLandingHeader'

const VisitDropDown = ({ darkMode, setDarkMode, openMenu, setOpenMenu, singleLocation, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      <VisitLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} singleLocation={singleLocation} />
