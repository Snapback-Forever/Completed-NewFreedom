...
import WhyLandingHeader from './WhyLandingHeader'
import moment from 'moment'

const WhyDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      {landingContent?.whyMainImg && landingContent?.whySub !== "" || landingContent?.whyImgBucketName && landingContent?.whySub !== "" ?
        <WhyLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} newGif={newGif} newGif2={newGif2} />
        : ""}
