...
import VocationalLandingHeader from './VocationalLandingHeader'
import moment from 'moment'
import { Link } from 'react-router-dom'

const VocationalDropDowns = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "what" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Vocational Training</button>
...
export default VocationalDropDowns
