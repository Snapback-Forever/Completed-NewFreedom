...
const NewTrainingDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "happening" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON New Training Opportunities</button>
...
export default NewTrainingDropDown
