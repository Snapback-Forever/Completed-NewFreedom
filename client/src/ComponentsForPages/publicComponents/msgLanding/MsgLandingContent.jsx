...
const NewQuestionForm = ({ darkMode, setDarkMode  }) => {
  ...
  return (
    ...
    >
      ...
      <div className='messageUs' style={{ width: "100vw", display: "flex", flexDirection: "column", alignItems: "center", background: !darkMode ?  "rgba(255, 255, 255, 0.663)" : "rgba(0, 0, 0, 0.63)", margin: "0 0 2vh 0", color: darkMode ? "white" : "black", }}>
        <h2 style={{ width: "100%", textAlign: "center" }}>Send Us A Message</h2>
        <h4 style={{ width: "90%", textAlign: "center" }}>Please Make Sure You Submit Your Correct Email So We Can Respond. We Look Forward To Hearing From You. </h4>
      </div>
      ...
      >
        ...
        <h4 style={{ color: darkMode ? "white" : "black", width: "80%" }}>Title:</h4>
        <input
          type="text"
          className='responsiveInput'
          name="title"
          placeholder="I am interested in joining New Freedom...."
          value={form.title}
        ...
        <textarea
          name="body"
          placeholder="I would like to come and join the New Freedom Team."
          className='responsiveInput'
          value={form.body}
          onChange={handleChange}
          rows={4}
