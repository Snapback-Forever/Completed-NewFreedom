...
import MsgLandingHeader from './MsgLandingHeader'


const MsgDropDown = ({ newGif, newGif2, darkMode, setDarkMode, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters }) => {
  ...
  return (
    ...
    <div >
      ...
      <MsgLandingHeader darkMode={darkMode} setDarkMode={setDarkMode} newGif={newGif} newGif2={newGif2} />
        ...
        <div style={{ position: "relative", width: "100%", textAlign: "center", background: "goldenRod", margin: "0 1vw" }} className='rounded responsiveDiv' onMouseLeave={() => setOpenMenu("")}>
          ...
          {openMenu === "who" && (
            ...
            >
              ...
              <button className='rounded' disabled style={{ border: "solid goldenRod", background: "lightGrey", width: "100%", margin: "0.5vh 0", color: "black" }}>ON Send Us A Message</button>
