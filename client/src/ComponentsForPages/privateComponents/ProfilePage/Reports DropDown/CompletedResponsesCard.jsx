...
import { deleteQuestion, updateQuestion, updateQuestionStatus } from '../../../../../src/redux/reducers/questionReducers';

import { Link } from 'react-router-dom';

const CompletedResponsesCard = ({ quest, trigger, setTrigger }) => {
  ...
  return (
    <div style={{ width: "90vw", background: "rgba(250, 235, 215, 0.960)", margin: "1vh 0", display: "flex", flexDirection: "column", border: "solid antiqueWhite", padding: "1vw" }} className='responsiveGuestMsg'>
      ...
      <h6 style={{ width: "100%", textAlign: "center", padding: "2vw" }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(quest?.body) }} />
...
export default CompletedResponsesCard