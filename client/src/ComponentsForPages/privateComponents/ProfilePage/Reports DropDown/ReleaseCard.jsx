...
const ReleaseCard = ({ mentee, setTrigger, allPrograms, allUsers }) => {
    ...
    const handleSaveMenteeImage = (fieldPrefix) => async () => {
        ...
        const hasGridFsImage = !!mentee.menteeImageFileId && !!mentee.menteeImageBucketName;
    ...
    const imgSrcMentee = mentee?.menteeImageFileId && mentee?.menteeImageBucketName
        ? `${baseUrl}/upload/image/${mentee?.menteeImageFileId}?bucketName=${mentee?.menteeImageBucketName}`
        : mentee?.menteeImage;
    ...
    return (
        <div key={mentee?._id} style={{ width: "90vw", display: "flex", flexDirection: "column", border: "1px solid black", padding: "3vh 1vw", background: "white", margin: "2vh 0" }} className='responsiveAllMenteeCards'>
            ...
            {showMoreMentee ?
                ...
                <div style={{ width: "100%" }}>
                    ...
                    {mentee.currentCharge ? <h6><b>Current Charge:</b> {mentee.currentCharge}</h6> : "No Current Charges"}
