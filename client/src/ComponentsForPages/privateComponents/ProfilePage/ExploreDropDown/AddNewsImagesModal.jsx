...
import { addAdditionalNewsImages } from '../../../../redux/reducers/newsLetterReducer'

const AddNewsImagesModal = ({ setTrigger, setAddImage, newsInfo, setNewsInfo }) => {
    ...
    const handleSaveImage = (fieldPrefix) => async (e) => {
        ...
        try {
            ...
            if (file) {
                ...
                const uploadUrl = `${baseUrl}/upload/image/${newsInfo?._id}`
            ...
            await dispatch(addAdditionalNewsImages(payload)).unwrap?.()
    ...
    return (
        <div className="addImageProModal scrollBar">
            ...
            {!form.programImagePreview ? <><label style={{ textAlign: 'center' }}>
                    <b>OR Image Link:</b>
                </label>
...
export default AddNewsImagesModal