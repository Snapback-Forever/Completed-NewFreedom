...
const AdminMsgCard = ({ post, trigger, setTrigger }) => {
    ...
    return (
        ...
        <>
            <div style={{ width: "90vw", background: "rgba(250, 235, 215, 0.960)", margin: "1vh 0", display: "flex", flexDirection: "column", border: "solid antiqueWhite", padding: "1vw" }}>
                ...
                <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(post?.postTitle) }} style={{ whiteSpace: "pre-wrap" }} />
                <div style={{ width: "100%", textAlign: "center", whiteSpace: "pre-wrap" }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(post?.postBody) }} />
                        ...
                        {post?.reply.filter(reply => reply).map(reply => {
                            ...
                            return (
                                <div style={{ width: "90%", background: "rgba(250, 235, 215, 0.960)", margin: "0.5vh 0", display: "flex", flexDirection: "column", border: "solid antiqueWhite", padding: "1vw" }} key={crypto.randomUUID()}>
                                    ...
                                    <div style={{ width: "100%", textAlign: "center", }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(reply?.replyMessage) }} />
