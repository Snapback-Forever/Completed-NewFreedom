...
const ModalFindUser = ({ allUsers, setOpenModalUser, msg, setTrigger, setResponse, onAddRecipient }) => {
    ...
    return (
        ...
        <div className='searchUserModal'>
            <button style={{ fontSize: "2rem" }} onClick={() => setOpenModalUser(false)} >❎</button>
                                    ...
                                    <div style={{ width: "100%", display: "flex", flexWrap: "wrap", overflowX: "scroll" }} className='scrollBar'>
                                        {list.map(user => (
                                            <UserCard
                                                ...
                                                onAddRecipient={onAddRecipient}   // NEW
                                            />
                                        ))}
                                    </div>
                                </div>
