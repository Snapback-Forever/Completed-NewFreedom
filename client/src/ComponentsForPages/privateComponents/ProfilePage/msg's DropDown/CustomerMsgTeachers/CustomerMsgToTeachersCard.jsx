...
const CustomerMsgToTeachersCard = ({ quest, trigger, setTrigger, allUsers }) => {

  const dispatch = useDispatch()

  const textareaRef = useRef(null)
  const textareaGuestRef = useRef(null)
                ...
                {response && (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      onKeyDown={(e) => handleDescriptionKeyDown(e, "responseGuest")}
                      required
                    />
...
export default CustomerMsgToTeachersCard