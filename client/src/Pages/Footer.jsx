import logo from "../../src/images/newFreedomLogo.png"
import snapBackLogo from "../../src/images/snapback.jpg"


import React, { useEffect, useRef, useState } from 'react'


const Footer = ({ openLogin, setOpenLogin }) => {

  const [shareMe, setShareMe] = useState(false)

  const websiteUrl = encodeURIComponent('https://newfreedomaz.com');
  const message = encodeURIComponent("NewFreedom A First for Second Chances - ") + websiteUrl;
  ...
  const MAX_INTERVAL = 600; // ms total window for 3 rapid clicks
  ...
  const handleClick = () => {
    ...
    const elapsed = now - firstClickTimeRef.current;
    // If too much time has passed, start a new sequence
    ...
    if (clickCountRef.current >= 3) {
      // 3 clicks within MAX_INTERVAL => open admin
      setOpenLogin(true);
      // reset sequence
  ...
  return (
    <div>
      <div style={{ width: "100%", display: "flex", justifyContent: "space-between", height: "6vh", background: "white" }} >
        <img src={logo} style={{ height: "6vh", marginLeft: "2vw" }} onClick={handleClick} title="Created By Snapback-Forever" />

        <div style={{ display: "flex" }}>

          {shareMe ? <div style={{ display: "flex", marginRight: "2vw" }} onMouseLeave={() => setShareMe(false)}>

            {/* facebook */}
            <a href={facebookShareUrl} target="_blank" rel="noopener noreferrer" title='facebook'>
            ...
            {/* Twitter */}
            <a href={twitterShareUrl} target="_blank" rel="noopener noreferrer" title='X'>
              <svg style={{ margin: "0 0.5vw", minHeight: "5vh", minWidth: "4vh", maxHeight: "5vh", maxWidth: "4vw" }} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* LinkedIn */}
            <a href={linkedinShareUrl} target="_blank" rel="noopener noreferrer" title='LinkedIn'>
              <svg style={{ margin: "0 0.5vw", minHeight: "5vh", minWidth: "4vh", maxHeight: "5vh", maxWidth: "4vw" }} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* WhatsApp */}
            <a href={whatsappShareUrl} target="_blank" rel="noopener noreferrer" title='WhatsApp'>
            ...
            <h3 style={{ height: "100%", display: "flex", alignItems: "center", marginRight: "2vw" }} onMouseEnter={() => setShareMe(true)} onClick={() => setShareMe(true)}>Share Us</h3>}
