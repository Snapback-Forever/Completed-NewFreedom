...
import MentorDropDown from '../../ComponentsForPages/publicComponents/MentorLanding/MentorDropDown'
import MentorLandingContent from '../../ComponentsForPages/publicComponents/MentorLanding/MentorLandingContent'

const MentorsLanding = ({ darkMode, setDarkMode, openLogin, setOpenLogin, contactUs, setContactUs, openMenu, setOpenMenu, landingContent, allStories, allNewsLetters, allEvents }) => {
    ...
    return (
      ...
      <div>
        ...
        <div style={{ height: "89vh", overflowY: "scroll" }} className='scrollBar'>
          ...
          <MentorLandingContent darkMode={darkMode} setDarkMode={setDarkMode} landingContent={landingContent} />
